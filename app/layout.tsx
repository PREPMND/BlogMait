  ...
  return (
    ...
    >
      <body className="h-full flex flex-col">
        <ThemeProvider attribute={'class'}  defaultTheme="system" enableSystem disableTransitionOnChange containerClassName=" md:w-[70%] w-[95%] border-l-1 border-r-1 min-h-[85vh] border-gray-300 rounded-md dark:border-neutral-500">
          {children}
        </ThemeProvider>
      </body>
