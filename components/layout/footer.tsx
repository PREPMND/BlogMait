mt-10 w-full md:w-[90%] mx-auto h-16 flex justify-center items-center
"use client";
...
export default function Footer() {
    return (
        <footer className="relative mt-32 overflow-hidden border-t border-white/10 bg-neutral-950">
            {/* Background */}
