    ...
    return (
        <div className="[perspective:1000px] select-none">
            ...
            <motion.div
                ...
                className="glowing-card w-[90%] md:w-[100%] h-[40%] p-6 bg-neutral-900 text-neutral-100 cursor-pointer border border-neutral-700 rounded-2xl flex flex-col justify-between transition-colors duration-200"
            >
                <div
