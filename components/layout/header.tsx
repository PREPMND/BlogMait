...
export default function Header() {
    ...
    return (
        <div className="w-full select-none dark: px-4 z-50 rounded-b-md rounded-l-sm rounded-r-sm bg-white pb-2 shadow-sm  shadow-olive-300 sticky top-2  md:w-[95%] mx-auto h-18 flex justify-between items-center">
