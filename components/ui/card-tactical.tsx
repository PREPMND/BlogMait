    ...
    return (
        <div className="[perspective:1000px] select-none">
            ...
            >
                ...
                <div
                    className="pt-4 border-t bg-neutral-800 shadow-neutral-400 shadow-lg border-neutral-700 flex items-center justify-between text-xs text-neutral-500 pointer-events-none"
