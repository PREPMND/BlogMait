  ...
  return (
    ...
    >
      <body className="h-full flex flex-col">
        <ThemeProvider attribute={'class'}  defaultTheme="system" enableSystem disableTransitionOnChange containerClassName=" md:w-[70%]  w-[99%] border-l-1 border-r-1 min-h-[100vh] dark:bg-neutral-900 bg-white/70 border-gray-300 rounded-md dark:border-neutral-700">
          {children}
        </ThemeProvider>
      </body>
